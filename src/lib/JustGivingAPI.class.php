...
XMLDOC;
    ...
    public static function retrievePage($shortName) {
        $url = sfConfig::get('app_retrieve_page_sand', 'https://api.staging.justgiving.com/50694b0a/v1/fundraising/pages/{pageShortName}');
        $url = str_replace('{pageShortName}', $shortName, $url);
